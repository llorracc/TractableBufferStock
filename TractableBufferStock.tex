...
\pagebreak 
\opt{Aquamacs}{\pagebreak} % CDCPrivate for some reason the page break on the first page is messed up in the Aquamacs mode
...
\includegraphics[width=6in]{\FigDir/TractableBufferStockPhaseDiag}
\end{figure}
...
\includegraphics[width=6in]{\FigDir/TractableBufferStockcFunc}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/TractableBufferStockcFunc.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/TractableBufferStockcFunc.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/TractableBufferStockcFunc.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/TractableBufferStockcFunc.png} % CDCPrivate
\end{figure}
...
\includegraphics[width=6in]{\FigDir/TractableBufferStockGrowthA}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/TractableBufferStockGrowthA.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/TractableBufferStockGrowthA.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/TractableBufferStockGrowthA.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/TractableBufferStockGrowthA.png} % CDCPrivate
\end{figure}
...
\includegraphics[width=6in]{\FigDir/TractableBufferStockGrowthB}
\label{fig:GrowthB}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/TractableBufferStockGrowthB.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/TractableBufferStockGrowthB.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/TractableBufferStockGrowthB.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/TractableBufferStockGrowthB.png} % CDCPrivate
\end{figure}
...
\includegraphics[width=6in]{\FigDir/cGroIncreaseMhoPlot}
\label{fig:cGroIncreaseMhoPlot}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/cGroIncreaseMhoPlot.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/cGroIncreaseMhoPlot.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/cGroIncreaseMhoPlot.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/cGroIncreaseMhoPlot.png} % CDCPrivate
\end{figure}
...
\includegraphics[width=6in]{\FigDir/PhaseDiagramDecreaseThetaPlot}
\label{fig:DecreaseTheta}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/PhaseDiagramDecreaseThetaPlot.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/PhaseDiagramDecreaseThetaPlot.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/PhaseDiagramDecreaseThetaPlot.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/PhaseDiagramDecreaseThetaPlot.png} % CDCPrivate
\end{figure}

\begin{figure}
\caption{Path of ${\cRat}^{e}$ Before and After $\timeRate$ Decline}
\includegraphics[width=6in]{\FigDir/cPathAfterThetaDrop}
\label{fig:cPathAfterThetaDrop}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/cPathAfterThetaDrop.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/cPathAfterThetaDrop.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/cPathAfterThetaDrop.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/cPathAfterThetaDrop.png} % CDCPrivate
\end{figure}

\begin{figure}
\caption{Path of $\mRatE$ Before and After $\timeRate$ Decline}
\includegraphics[width=6in]{\FigDir/mPathAfterThetaDrop}
\label{fig:mPathAfterThetaDrop}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/mPathAfterThetaDrop.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/mPathAfterThetaDrop.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/mPathAfterThetaDrop.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/mPathAfterThetaDrop.png} % CDCPrivate
\end{figure}
...
\medskip
\includegraphics[width=6in]{\FigDir/MPCPathAfterThetaDrop}
\label{fig:MPCPathAfterThetaDrop}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/MPCPathAfterThetaDrop.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/MPCPathAfterThetaDrop.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/MPCPathAfterThetaDrop.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/MPCPathAfterThetaDrop.png} % CDCPrivate
\end{figure}
...
\includegraphics[width=6in]{\FigDir/SOEStakescPathAfterThetaDropPlot}
\label{fig:SOEStakescPathAfterThetaDropPlot}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/SOEStakescPathAfterThetaDropPlot.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/SOEStakescPathAfterThetaDropPlot.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/TractableBufferStock/Figures/SOEStakescPathAfterThetaDropPlot.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/SOEStakescPathAfterThetaDropPlot.png} % CDCPrivate
\end{figure}
...
\includegraphics[width=6in]{\FigDir/SOENoStakescPath}
\label{fig:SOENoStakescPath}
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/SmallOpenEconomy/Figures/SOENoStakescPath.pdf /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/SOENoStakescPath.pdf} % CDCPrivate
\write18{ln -fs /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Code/Mathematica/Examples/SmallOpenEconomy/Figures/SOENoStakescPath.png /Volumes/Data/Courses/Choice/LectureNotes/Consumption/Handouts/TractableBufferStock/Figures/SOENoStakescPath.png} % CDCPrivate
\end{figure}
...
in $\urate$?  % Actually, I think the answer to this one is easy: $\unins = \urate/\Alt{\urate}$
\end{itemize}
...
\begin{CDCPrivate} % Some of these ideas are explored in cFuncExamineCarfully.nb; not ultimately very fruitful
...
\begin{comment} % In the end, the approach defined in this comment did not work
% The problem was that the resulting consumption function did not asymptote to the perfect foresight function
Recognizing that $\lim_{\mRat \rightarrow \infty} \MPCFunc(\mRat)$ is a constant, analysis of \eqref{eq:kappaPExpr} leads 
to the conclusion that the limiting functional form of $\MPCFunc^{\prime}(\mRat)$ is linear in $\mRat^{-1}$; that is, for some $\chi_{0}$ % and $\chi_{1}$, 
\begin{equation}\begin{gathered}\begin{aligned}
...
Start by assuming that \eqref{eq:cPPlimInf} holds exactly at the target level of wealth, 
from which we can derive a unique
\begin{equation}\begin{gathered}\begin{aligned}
   \chi_{0} & =  \MPC^{e \prime} \mTarg^{\null}
\end{aligned}\end{gathered}\end{equation}
and by integration we construct
\begin{equation}\begin{gathered}\begin{aligned}
  -\cFunc^{\prime}(\mTarg^{\null}) & =  \chi_{2} - \chi_{0} \log \mTarg^{\null}
\\ \chi_{2} & =  \chi_{0} \log \mTarg^{\null} -\cFunc^{\prime}(\mTarg^{\null}) 
\\ -\cFunc(\mTarg^{\null}) & =  \chi_{3} + \chi_{2} \mTarg^{\null} - \chi_{0}(-\mTarg^{\null}+ \mTarg^{\null} \log \mTarg^{\null})
\\ \chi_{3} & =  \chi_{0}(-\mTarg^{\null} + \mTarg^{\null} \log \mTarg^{\null}) - \chi_{2} \mTarg^{\null} - \cFunc(\mTarg^{\null})
\end{aligned}\end{gathered}\end{equation}
so that an approximation to the consumption function which matches the level and the first two
derivatives of the consumption function at the target is given by 
\begin{equation}\begin{gathered}\begin{aligned}
  \label{eq:cFuncLimInfty}
   \cFunc(\mRat) & =  -\left(\chi_{3} + \chi_{2} \mRat - \chi_{0} (- \mRat + \mRat \log \mRat)  \right)
\end{aligned}\end{gathered}\end{equation}


Designating the final points obtained by the reverse shooting iterations using the $\barwedge$ 
subscript (e.g. the last value of $\cons$ is $\cons_{\barwedge}$), we begin with the observation
that if \eqref{eq:cPPlimInf} holds true then 
\begin{equation}\begin{gathered}\begin{aligned}
  \label{eq:cPPPlimInf}
  -\cPPP_{\barwedge} & =  \chi_{0} \mRat^{-2}
\end{aligned}\end{gathered}\end{equation}
and since the interpolating approximation constructed above produces a direct estimate of $\cPPP$ 
at the final point in the iteration, we can obtain a direct estimate of $\chi_{0}$ from
\begin{equation}\begin{gathered}\begin{aligned}
  \chi_{0} & =  -\cPPP_{\barwedge} \mRat^{2}
.
\end{aligned}\end{gathered}\end{equation}
...
\begin{CDCPrivate} % This actually works reasonably well; somewhat better (it seems) than the w method described below, but not as well as approximating the consumption function and producing the value function by integration (outside the interpolation point boundaries)
...
(1-\bar{\MPC}^{e})^{1-\CRRA}\mathfrak{v})^{\frac{\CRRA}{1-\CRRA}} %\\ & =  \lim_{\mRat \rightarrow 0} (\bar{\MPC}^{e} m)^{-\CRRA} (\crho(\uFunc(\bar{\MPC}^{e} m)(1 + \Discount \PGro^{1-\CRRA} \urate (1-\bar{\MPC}^{e})^{1-\CRRA})))^{\frac{\CRRA}{1-\CRRA}} 
%\\ & =  \lim_{\mRat \rightarrow 0} (\bar{\MPC}^{e} m)^{-\CRRA} ((\bar{\MPC}^{e} m)^{1-\CRRA}/(1-\Discount \PGro^{1-\CRRA} \urate))^{\frac{\CRRA}{1-\CRRA}} 
%\\ & =  \lim_{\mRat \rightarrow 0} (1/(1-\Discount \PGro^{1-\CRRA} \urate))^{\frac{\CRRA}{1-\CRRA}} 
% I think this one is not right : \\ \lim_{\mRat \rightarrow 0} \nFuncPP(\mRat) & =  0
\end{aligned}\end{gathered}\end{equation}
...
\begin{CDCPrivate}
\begin{equation}\begin{gathered}\begin{aligned}
  \Delta {\cRat}^{e}_{t+1} & \approx  \Delta \mRatE_{t+1}\MPCE 
\end{aligned}\end{gathered}\end{equation}
and
\begin{equation}\begin{gathered}\begin{aligned}
  \Delta \mRatE_{t+1} & =  (\mTarg^{\null} + \blacktriangle_{t} -\cFunc(\mTarg^{\null}+\blacktriangle_{t}))\Rnorm + 1 - (\mTarg^{\null}+\blacktriangle_{t})
\\ & \approx  \mTarg^{\null}+\blacktriangle_{t}- (\cTarg^{e}+ \blacktriangle_{t} \MPCE)\Rnorm + 1 - (\mTarg^{\null}+\blacktriangle_{t})
\\ & =  \underbrace{(\mTarg^{\null}-\cTarg^{e})\Rnorm+1}_{\mTarg^{\null}} -\mTarg^{\null} + ((1-\MPCE) \Rnorm-1)\blacktriangle_{t}
\\ & =  (\rfree  - \MPCE \Rnorm) \blacktriangle_{t}
\end{aligned}\end{gathered}\end{equation}
\end{CDCPrivate} 
\begin{equation}\begin{gathered}\begin{aligned}
